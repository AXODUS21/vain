...
const Mic = ({ isRecording }) => {
  ...
  return (
    <StyledWrapper>
      <>
        <input type="checkbox" id="checkbox" checked={isRecording} readOnly />
...
const StyledWrapper = styled.div`
  .switch {
    ...
    align-items: center;
    background-color: rgb(107, 255, 137);
    color: #ffff;
    border-radius: 50%;
    cursor: pointer;
  ...
  .switch:hover {
    background-color: rgb(107, 255, 137, 0.8);
  }
  ...
  /* Add animation based on isRecording */
  .switch:before {
    content: "";
    position: absolute;
    top: 50%;
